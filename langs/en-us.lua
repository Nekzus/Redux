...
langs["en-us"] = {
	...
	["itemFinishTip"] = "Say `%s` to cancel the creation of the item",
	...
	["notAvailableLang"] = "Sorry, but this command is not supported for the current selected language!",
	...
	["mutedRoleTip"] = "Don't forget to set a `Muted` role with **%ssetmutedrole**",
	["modRoleTip"] = "Don't forget to set a `Moderator` role with **%ssetmodrole**",
	["adminRoleTip"] = "Don't forget to set a `Administrator` role with **%ssetadminrole**",
	["orgRoleTip"] = "Don't forget to set a `Organizer` role with **%ssetorgrole**",
	...
	["storeItemRequiredTime"] = "Required time",
